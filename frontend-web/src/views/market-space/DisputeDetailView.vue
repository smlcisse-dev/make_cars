...
import { fetchDispute, fetchDisputeAttachmentBlob, respondToDispute } from '@/api/marketSpaceDisputes'
...
<template>
  <div class="max-w-3xl space-y-6">
    <button type="button" class="text-sm text-slate-500 hover:text-slate-700" @click="router.push({ name: 'market-space.disputes' })">
