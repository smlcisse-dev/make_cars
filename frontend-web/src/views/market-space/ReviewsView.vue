...
import { fetchMarketSpaceReviews } from '@/api/marketSpaceReviews'
import AppPagination from '@/shared/components/AppPagination.vue'
import StatusBadge from '@/shared/components/StatusBadge.vue'
import type { MarketSpaceReview } from '@/types/marketSpaceReview'
import { extractApiErrorMessage } from '@/utils/apiError'

const reviews = ref<MarketSpaceReview[]>([])
...
async function loadReviews(): Promise<void> {
  ...
  try {
    const response = await fetchMarketSpaceReviews(currentPage.value)
