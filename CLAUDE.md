...
- **Frontend** : composant réutilisable `LocationSelect.vue` (`shared/components`) ; page de test temporaire `/garage/location-test`, à supprimer quand le composant sera intégré au vrai écran de profil Garagiste/Market Space.
